...
public class TestServiceServiceLocator extends org.apache.axis.client.Service implements cn.lijuntao.TestServiceService {
    ...
    public cn.lijuntao.TestService_PortType getTestService() throws javax.xml.rpc.ServiceException {
    ...
    public cn.lijuntao.TestService_PortType getTestService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.lijuntao.TestServiceSoapBindingStub _stub = new cn.lijuntao.TestServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.lijuntao.TestService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.lijuntao.TestServiceSoapBindingStub _stub = new cn.lijuntao.TestServiceSoapBindingStub(new java.net.URL(TestService_address), this);
                _stub.setPortName(getTestServiceWSDDServiceName());
                return _stub;
            }
        }
